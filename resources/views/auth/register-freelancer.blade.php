...
<head>
    <meta charset="UTF-8">
    <title>Register as Freelancer | شغلني</title>
...
<body class="min-h-screen flex items-center justify-center font-sans selection:bg-primary-500 selection:text-white py-12 px-6">
    ...
    <main class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-white mb-2">Join as a Freelancer</h1>
            <p class="text-gray-400 text-sm">Create your profile to start finding work.</p>
        </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <select name="specialization" required 
                                class="w-full bg-dark-800 border border-dark-600 text-white text-sm rounded-xl py-3 px-4 appearance-none focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 cursor-pointer">
                            <option value="Web Developer" {{ old('specialization') == 'Web Developer' ? 'selected' : '' }}>Web Developer</option>
                        </select>
                        <!-- Custom Arrow -->
